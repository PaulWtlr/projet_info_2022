...
class Voronoi:
    ...
    def correct_seg(self):
        ...
        n4_div = False
        for s1 in Ls_edge:
            if [s1.start.x, s1.start.y] == [s1.end.x, s1.end.y]:
                Ls_edge.remove(s1)
            if s1.start.x == 500 and s1.start.y != s1.end.y :
                n1_div = True
            elif ([s1.start.x,s1.start.y,s1.end.x,s1.end.y] == [500,0,500,500] or [s1.start.x,s1.start.y,s1.end.x,s1.end.y] == [500,500,500,0]) and n1_div :
                Ls_edge.remove(s1)
            elif s1.start.y == 500 and s1.start.x != s1.end.x :
                n2_div = True
            elif ([s1.start.x,s1.start.y,s1.end.x,s1.end.y] == [0,500,500,500] or [s1.start.x,s1.start.y,s1.end.x,s1.end.y] == [500,500,0,500]) and n2_div :
                Ls_edge.remove(s1)
            elif s1.start.x == 0 and s1.start.y != s1.end.y :
                n3_div = True
            elif ([s1.start.x,s1.start.y,s1.end.x,s1.end.y] == [0,0,0,500] or [s1.start.x,s1.start.y,s1.end.x,s1.end.y] == [0,500,0,0]) and n3_div :
                Ls_edge.remove(s1)
            elif s1.start.y == 0 and s1.start.x != s1.end.x :
                n4_div = True
            elif ([s1.start.x,s1.start.y,s1.end.x,s1.end.y] == [0,0,500,0] or [s1.start.x,s1.start.y,s1.end.x,s1.end.y] == [500,0,0,0]) and n4_div :
                Ls_edge.remove(s1)
